        ...
        plugins: [
          {
            ...
            */
            handlerDidError: async () =>
              // `ignoreSearch` because the stored copy carries a revision in
              // its query string, and a redirect here does not survive a
              // navigation the browser has already committed to.
